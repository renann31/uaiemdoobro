...
const PorqueSection = () => {
    return(
    <>
        <div className="w-80 mx-auto mt-40 mb-20 md:w-230 md:mt-10">
        ...
        <div className="md:w-224 md:flex md:gap-8 md:mx-auto">
            ...
            return (
                <div key={index} className="w-80 h-54 mx-auto flex flex-col mb-8 text-center p-4 px-6 rounded-xl shadow-[0_10px_15px_rgba(0,0,0,0.25)]">
