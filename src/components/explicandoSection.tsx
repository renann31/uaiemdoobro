...
const ExplicandoSection = () => {
    return (
        <div className="text-center w-85 mx-auto my-50 md:w-320">
            ...
            <div className="md:flex md:gap-5">
                {comoFunciona.map((card, index) => { 
                    return (
                        <div
                            className="bg-white h-67 flex flex-col items-center rounded-xl w-85 mx-auto mb-8 p-7 shadow-xl md:w-97"
                            key={index}
                        >
