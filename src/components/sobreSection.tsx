const SobreSection = () => {
    ...
    <>
        <div className="h-89.5 w-full text-center flex flex-col justify-center"
            ...
            <div className="w-80 mx-auto flex flex-col justify-center md:w-210.5">
        ...
        <div className="w-80  mx-auto text-center mt-15 md:w-224 md:h-109 md:space-y-5">
        ...
        <div className="h-141.75 w-80 mx-auto mt-15 md:flex md:w-224 md:gap-8 ">
            <div className="h-67 p-5 px-10 rounded-xl"
                ...
                <div className="flex flex-col justify-center gap-1">
                    ...
                    <h1 className="text-white text-[24px] font-bold mb-1">Compre 1, Ganhe 1</h1>
                    <p className="text-white text-[16px] font-light ">A cada prato que você compra em um restaurante participante, você ganha outro prato de igual valor. Simples assim!</p>
                </div>
            </div>
