const Header = () => {
    return (
        <div
            ...
            <div className="h-130.5 w-75 md:w-224 leading-tight mx-auto pt-5">
                ...
                <div className="bg-white/10 h-53 rounded-2xl items-center text-left mt-10 pt-5 p-8 md:max-w-115.5 md:mx-auto md:h-48 md:px-15 md:pt-0">
                    <h1 className="text-[46px] font-medium md:text-[64px] text-[#FFEAB6]">menos de <span className="font-black">1 real</span> /dia</h1>
                    <p className="text-[14px] font-light opacity-80 text-text-white text-center mt-4 md:mt-0">no plano anual de R$ 358,80</p>
                </div>
