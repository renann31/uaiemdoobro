        ...
        <>
            {home &&
             <div className="h-172.5 w-full text-center mt-20 pt-10 px-3" style={{ background: "var(--bg-linear)" }}>
                <h1 className="text-white font-black text-[30px] md:text-[48px] md:mt-20">Pronto para Explorar  Economizando?</h1>
                <p className="text-white text-[24px] font-light mt-10">Quer saber de todas as  novidades do Uai em Doobro? </p>
                <p className="text-white text-[24px] font-light">Basta fazer o seu cadastro aqui!</p>
                <form className="mt-20">
                    <input
                        type="email"
                        className="w-79.5 shadow-[inset_0px_5px_4px_rgba(255,255,255,0.25),0_4px_4px_rgba(0,0,0,0.25)] text-white font-bold text-[15px] bg-white/10 w-79.5 h-12.75 mx-auto   rounded-md py-2 px-5 placeholder:text-white md:w-170 md:h-10 md:rounded-2xl md:placeholder:text-white/55"
                        placeholder="DIGITE SEU EMAIL" />
                </form>
                <button className="bg-[#F6B22B] text-[#232126] w-85 h-15 mt-20 rounded-xl font-bold text-[18px] md:w-51 md:h-11 md:rounded-lg">CADASTRAR</button>
            </div>
        }
                ...
                <div className="md:flex md:w-304 md:gap-40 md:mx-auto md:items-center md:-translate-y-10 md:ml-30 2xl:ml-50 md:max-h-33.5">
                    ...
                    <div className="md:flex md:flex-col text-left">
                        ...
                        <div className="mt-5 md:gap-3 md:flex md:flex-col">
                            <a href="mailto:contato@uaiemdoobro.com.br" className="font-light text-[16px] text-[#99A1AF] ml-3 underline">contato@uaiemdoobro.com.br</a>
