...
const VantagensSection = () => {
  return (
    <div className="w-85 mx-auto text-center md:w-320">
      <div className="mb-16">
      ...
      <div className="grid md:grid-cols-3 md:px-8">
        {vantagens.map((card, index) => {
          return (
            <div key={index} className="bg-white w-full h-60 drop-shadow-lg py-6 md: pl-6 pr-3 text-left mb-8 rounded-xl space-y-4 md:w-96 md:h-60">
